            ...
            {!postSubmit && (
              ...
              {step === 2 && (
                <div className='flex flex-col'>
                  ...
                  <label className="mb-4">  
                    Sex:
                    <select name="sex" value={formValues.sex} onChange={handleInputChange} className="border border-gray-300 rounded-md px-3 py-1 w-full">
                    ...
                    <label className="mb-4">  
                        Marital Status:
                        <select name="maritalStatus" value={formValues.maritalStatus} onChange={handleInputChange} className="border border-gray-300 rounded-md px-3 py-1 w-full">
