...
const SeniorCitizenApplicationForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    const folderRef = storageRef(storage, 'Forms/senior');
    ...
    try {
      ...
      const formRef = dbRef(database, 'submissions/forms/senior/pending');
  ...
  return (
    <div>
        <StaticNavBar />
        <HeroP text='Senior Citizen Application'/>
        <div className="flex justify-center py-10 w-full h-full bg-gray-100">
          ...
          <div className="bg-white rounded-lg shadow-lg w-[60%]">
            <div className='text-center items-center w-full bg-blue-200 mb-10'>
              <h1 className='text-center text-2xl align-middle py-10'>Senior Citizen Application</h1>
            </div>
            ...
            {!postSubmit && (
              ...
              {step === 1 && (
                <div className='text-left'>
                  ...
                  <p className='py-5'>By submitting your contact information for a Senior Citizen Application, you agree to keep it accurate and private. We'll use your information only for processing your application. </p>
                  <label className="">
...
export default SeniorCitizenApplicationForm;
