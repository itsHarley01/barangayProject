...
const ComplaintsForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    const formRef = dbRef(database, 'submissions/forms/complaints');
        ...
        <div className="flex justify-center py-10 w-full h-full bg-gray-100">
          ...
          <div className="bg-white rounded-lg shadow-lg w-[60%]">
            <div className='text-center items-center w-full bg-blue-200 mb-10'>
              <h1 className='text-center text-2xl align-middle py-10'>Complaints</h1>
            </div>
            ...
            {!postSubmit && (
              ...
              {step === 1 && (
                <div className='text-left'>
                  ...
                  <p className='py-5'>By submitting your contact information for a Complaint, you agree to keep it accurate and private. We'll use your information only for processing your application. </p>
                  <label className="">
              ...
              {step === 3 && (
                <div className='flex flex-col'>
                  <h2 className="text-xl mb-4">Step 3: Complaint</h2>
                  <label className="mb-2">
                    Complaint(s):
                    <textarea type="text" name="complaint" value={formValues.complaint} onChange={handleInputChange} className="border border-gray-300 rounded-md px-3 py-1 w-full" />
                  </label>
              ...
              {postSubmit && (
                <div className='flex flex-col'>
                  <h2 className="text-xl mb-4 "></h2>
                    <p className='text-center py-10'>Your feedback is valuable to us. Thank you for filing a complaint.</p>
