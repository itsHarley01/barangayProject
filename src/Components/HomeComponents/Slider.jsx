    ...
    <div className="m-20 h-full"  >
      ...
      <Slider {...settings}>
        {newsData.map((newsItem, idx) => (
          <div key={idx} className={idx === newsIndex ? "justify-center transform scale-100 opacity-100 transition-transform duration-300 w-full " : "justify-center opacity-50 trasform scale-[0.6] transition-transform duration-300"}>
            <NewsCard   
